...
<div class="control-group">
    ...
    <div class="controls">
        <input name="publish_date" data-toggle="datepicker" value="" type="text" data-rules="required"  class="input-medium">        
    </div>
</div>
<div class="control-group">
    <label class="control-label"><b class="text-danger">*</b>链接地址：</label>
    <div class="controls">
        <input name="link"  value="" type="text" class="input-xxlarge" data-rules="required">        
    </div>
</div>
<div class="control-group">
