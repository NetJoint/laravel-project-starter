...
<div class="control-group">
    <label class="control-label"><b class="text-danger">*</b>同名发布源：</label>
    <div class="controls">
        <label class="radio-pretty inline checked">
            <input type="radio" data-rules="required" value="1" name="include_feed" checked="checked" autocomplete="off"><span>创建</span>
        </label>
        <label class="radio-pretty inline">
            <input type="radio" data-rules="required" value="0" name="include_feed" autocomplete="off"><span>不创建</span>
        </label>
    </div>
</div>
<div class="control-group">
...
<div class="control-group">
    ...
    <div class="controls">
        ...
        <label class="checkbox-pretty inline checked">
            <input type="checkbox" value="1" name="identity_other" checked="checked" autocomplete="off"><span>其他（含未登录）</span>
        </label>
    </div>
</div>
<div class="control-group">
